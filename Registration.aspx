<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="JSWithWebForms.Registration" %>
    ...
    <script type="text/javascript">
        ...
        $("#btnSubmit").click(function () {
            ...
            $.ajax({
                ...
                data: "{ Name: '" + name + "', Address: '" + address + "', Email: '" + email + "', Phone: '" + phone + "', Remarks: '" + remarks + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
                    debugger;
